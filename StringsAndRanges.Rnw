...
\begin{frame}[fragile]{Example bam file}

{\tt http://samtools.sourceforge.net/SAMv1.pdf}
{\tt http://picard.sourceforge.net/explain-flags.html}
{\tt http://www.illumina.com/truseq/tru\_resources/datasets.ilmn}
\end{frame}
